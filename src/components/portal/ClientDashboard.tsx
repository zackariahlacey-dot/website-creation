      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-8">
            ...
            {activeProject.status === 'live' ? (
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2 pt-2">
                  {[
                    "SCANNING_COMPETITOR_GAPS...",
                    "MAPPING_VERMONT_GEO_NODES...",
                    "CALIBRATING_CONVERSION_PATH..."
                  ].map((text, i) => (
          ...
          <section className="glass p-8 rounded-[48px] border-white/5 relative overflow-hidden group">
            ...
            <p className="text-zinc-500 text-[10px] mb-8 leading-relaxed font-medium">
              Upload brand guidelines, high-res photography, or clinical certificates directly to our build node.
            </p>
          ...
          <div className="p-10 bg-zinc-950 border border-white/5 rounded-[48px] text-center shadow-2xl relative overflow-hidden group">
            <div className="absolute inset-0 bg-violet-500/[0.02] opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
            <p className="text-[8px] font-black text-zinc-700 uppercase tracking-[0.4em] mb-6 text-center relative z-10">Direct Architect Access</p>
            <p className="text-2xl font-bold text-white mb-2 relative z-10 select-all tracking-tighter">802-585-9179</p>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest relative z-10 font-black">Zack Lacey</p>
          </div>
        </div>
      </div>
    </div>
