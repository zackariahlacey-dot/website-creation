          ...
          <div className="relative z-10 space-y-10">
            ...
            <div className="pt-8 border-t border-white/5">
              <form action="/auth/signout" method="post">
                <button className="text-[10px] font-black text-zinc-600 hover:text-white uppercase tracking-[0.5em] transition-all hover:tracking-[0.6em] group flex items-center gap-3 mx-auto text-center justify-center">
